...
function updatePositions() {
  ...
  /// fixed mistake here
  var dbs = (document.documentElement.scrollTop / 1250);
...
document.addEventListener('DOMContentLoaded', function() {
  /// restored back to 8 didnt realize wouldnt work correctly
  var cols = 8;
  var s = 256;
...
// *Changed to getElementById for moving pizzas
  ...
  console.log ("movingPizzas.length=", movingPizzas.length);
// *Reduced animated pizzas when page loads to 25
///changed Declared the elem variable (var elem;) in the initialisation of the for-loop to prevent it from being created every time the loop is executed
