...
Player.prototype.won = function() {
    this.gameWon = true;
    this.x = -200;
    document.getElementById("myResultDivId").innerHTML='Cat catches Mouse! You WIN congratulations!!! Please reload game if you would like to try again';  //changed to show player wins
    ;
};
